...
{
    QPdfWriter pdf(ui->TicketIdAdd->text()+".pdf");

    QPainter painter(&pdf);

    painter.drawText(100,1200,"TICKET ID :");
    painter.drawText(2800,1200,ui->TicketIdAdd->text());

    painter.drawText(100,1400,"SHOW ID  :");
    painter.drawText(2800,1400,ui->TicketShowIdAdd->text());

    painter.drawText(100,1600,"VIP SEAT :");
    if(ui->TicketVIPseatAdd->isChecked())
        painter.drawText(2800,1600,"NO VIP SEATS FOR YOU");
    else
